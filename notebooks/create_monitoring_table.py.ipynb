{
    "cells": [
        ...
        },
        {
            ...
            "outputs": [],
            "source": ["# %sh ls /local_disk0/.ephemeral_nfs/cluster_libraries/python/lib/python3.11/site-packages/"],
        },
        {
            "cell_type": "code",
            "execution_count": 0,
    ...
    "metadata": {
        "application/vnd.databricks.v1+notebook": {
            ...
            "language": "python",
            "notebookMetadata": {
                "mostRecentlyExecutedCommandWithImplicitDF": {"commandId": 2260984255359308, "dataframes": ["_sqldf"]},
                "pythonIndentUnit": 4,
            },
